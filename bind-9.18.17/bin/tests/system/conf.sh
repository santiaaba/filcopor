...
export TOP_BUILDDIR=/home/sdiaz/filcopor/bind-9.18.17
export TOP_SRCDIR=/home/sdiaz/filcopor/bind-9.18.17
...
#
export PERL=$(command -v "/usr/bin/perl" || true)
if ! test -x "$PERL"; then
    echo "Perl interpreter is required for system tests."
    exit 77
fi
export PYTHON=$(command -v "/usr/bin/python3" || true)
