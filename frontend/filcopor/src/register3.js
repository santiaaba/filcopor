      ...
      <Grid item xs={6} sx={{ backgroundColor: "white" }}>
        <Typography variant="body2" gutterBotto>
          <TextField
            ...
            rows={20}
            defaultValue='
            CONTRATO DE SERVICIO SAAS (SOFTWARE COMO UN SERVICIO) Empresa que
            presta el servicio SaaS: FilCoPor Sociedad de Hecho, con domicilio
            ...
            de las condiciones del presente contrato. CONDICIONES GENERALES 1.
            El servicio 1.1. FilCoPor es un servicio de filtrado de contenido
            ...
            dispositivos o pérdida de configuraciones. 1.2. FilCoPor no permite
            ...
            de un portal cautivo en el cual el cliente deberá autenticar. 1.3.
            FilCoPor admite utilizar el servicio en una LAN la cual obtiene
            acceso a Internet mediante NAT. Permitiendo a toda la LAN usar el
            servicio de FilCoPor con una sola cuenta de usuario. 1.4. FilCopor
            no admite más de 30 consultas de DNS por segundo provenientes de la
            misma IP pública. 1.5. FilCoPor puede ser utilizado desde Internet
            ...
            FilCoPor. 1.6. FilCoPor no permite usar la misma cuenta de usuario
            ...
            el portal de login. 1.7. Sobre el contenido filtrado. Se considera
            ...
            violencia o drogas. 1.8. El CLIENTE acepta que FilCoPor puede
            ...
            reportar el sitio a FilCoPor para que tome acciones. 1.9. FilCoPor
            se reserva el derecho de determinar cuál contenido debe ser filtrado
            y cuál no. Pudiendo el CLIENTE reportar sobre Falsos positivos y
            Falsos negativos a la espera de que un Administrador determine si
            dichos sitios reportados deben comenzar a considerarse entre los
            filtrados o no. 1.10. FilCoPor no filtra contenido accedido
            ...
            con malware. 2. Política de protección de datos FilCoPor, siguiendo
            ...
            la seguridad e integridad de las mismas. 2.3. FilCoPor se compromete
            a no vender, ceder o transferir los datos recogidos bajo ningún
            concepto. No obstante FilCoPor revelará a las autoridades públicas
            ...
            reglamentarias aplicables en cada caso. 2.4. FilCoPor asegura que
            protegerá la confidencialidad del correo electrónico intercambiando
            con el CLIENTE. 2.5. El CLIENTE tiene reconocidos sus derechos, y
            ...
            correo electrónico en la dirección info@filcopor.com. 2.6. El
            CLIENTE garantiza y responde, en cualquier caso, de la veracidad,
            ...
            actualizadas. 2.7. El CLIENTE autoriza de forma inequívoca a
            ...
            contratados. 2.8. El CLIENTE se compromete a cumplir las
            ...
            protección de datos de carácter personal. 3. Soporte técnico o
            consultas 3.1. FilCoPor ofrecerá soporte técnico o
            administrativo/comercial mediante la línea telefónica o correo
            electrónico brindados al cliente. 3.2. El tiempo de respuesta es de
            ...
            o Autonomías. 3.3. El servicio se prestará dentro del horario
            laboral de FilCoPor: de lunes a viernes de 9:00h. a 20:00h (huso
            horario GMT-3). 3.4. Los servicios de mantenimiento, actualizaciones
            ...
            router encendidos y bien configurados. 4. Precios, facturación y
            pagos del servicio prestado 4.1. FilCoPor informará al CLIENTE, en
            el propio proceso de suscripción, del precio del servicio o
            servicios contratados. 4.2. El pago de los servicios prestados es de
            ...
            crédito/debito. 4.3. El precio del servicio podrá ser modificado por
            ...
            tarifas. 4.4. En caso de devolución, retraso o impago de recibo de 5
            ...
            cuota que esté pagando. 4.6. Si diera el caso de tener que cancelar
            ...
            del CLIENTE. 5. Plazo de contrato y baja del servicio 5.0 Este
            ...
            el CLIENTE acepta éste contrato. 5.1 No existe obligación de
            ...
            cualquier momento como se detalla en los siguientes puntos. 5.2. El
            CLIENTE podrá anular el contrato solicitando con 5 días de
            ...
            del mes completo. 5.3. La baja se efectuará en un día laborable (de
            ...
            miembro de FilCoPor. 5.4 La baja del CLIENTE conlleva la eliminación
            ...
            CLIENTE un fichero de copia de base datos. 5.5. En caso de
            interceptar cualquier conducta o actividad ilegal, FilCoPor se
            reserva el derecho a denegar o cesar los servicios contratados sin
            previo aviso. 5.6. En el hipotético caso que FilCoPor cancelara el
            ...
            como ser Proveedor de Internet del CLIENTE. 6.2. El CLIENTE deberá
            comunicar la incidencia por correo electrónico a la dirección
            informatica@filcopor.com o a través de los canales que se
            especifican en la web relacionada con el producto suscrito. 6.3. En
            caso de que las incidencias puedan derivar de un mal uso por parte
            del CLIENTE, FilCoPor se reserva el derecho a facturar al CLIENTE
            estos gastos. 6.4. FilCoPor no se hace responsable de la adecuación
            ...
            impago de las cuotas. 6.5. El CLIENTE deberá poner todos los medios
            ...
            sospecha de que terceras personas las conocen. 7. Responsabilidades
            ...
            con este contrato. 7.2. FilCoPor no será responsable del
            ...
            catástrofes y otros eventos. 7.3. El CLIENTE se obliga a no
            subarrendar el servicio contratado a otros clientes o terceras
            personas. 8. Modificaciones 8.1. Las condiciones de este contrato
            ...
            aceptan las modificaciones de las condiciones del contrato. 9.
            Resolución de conflictos. Jurisdicción 9.1. Todas las divergencias
            que surjan entre LAS PARTES (CLIENTE y FilCoPor) que tengan origen
            y/o fundamento en la interpretación, aplicación, ejecución y/o
            ...
            Partes a cualquier otro fuero o jurisdicción que pudiera
            corresponder.
            '
          />
        </Typography>
